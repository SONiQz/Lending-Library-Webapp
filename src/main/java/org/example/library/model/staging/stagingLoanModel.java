...
public class stagingLoanModel {
    ...
    // Default constructor
    public stagingLoanModel() {
    }


    // Constructor with parameters
    public stagingLoanModel(String barcode, LocalDate dateLoaned, LocalDate dateReturned, LocalDate dueDate, double fees, String userId, boolean feesPaid, LocalDate feesPaidDate) {
        this.userId = userId;
